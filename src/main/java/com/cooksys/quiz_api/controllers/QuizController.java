...
public class QuizController {
	...
	public QuizResponseDto updatedQuizName(@PathVariable Long id, @PathVariable String newname) {
	...
	public QuestionResponseDto deletedQuestion(@PathVariable Long id, @PathVariable Long question_id){
